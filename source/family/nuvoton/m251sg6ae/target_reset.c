...
static uint8_t m251_target_set_state(target_state_t state)
{
    ...
    if (state == RESET_PROGRAM) {
        ...
        const program_target_t M251_flash = M251_PROGRAM_TARGET(load_address);
        memcpy(&flash, &M251_flash, sizeof(program_target_t));
...
const target_family_descriptor_t g_target_family_m251 = {
    .target_set_state = m251_target_set_state,
};

const target_family_descriptor_t *g_target_family = &g_target_family_m251;
